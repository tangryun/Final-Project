...
he dataset was collected during 60 days, this is a real database of a brazilian logistics company. The dataset has twelve predictive attributes and a target that is the total of orders for daily treatment. The database was used in academic research at the Universidade Nove de Julho.
...
# 1. 13 variables of the raw data could be reduced by 2 PCA principles. 

# 2. NUO contributes most to the effective information,  followed by type B and Bank2.

# 3. individual comtribution shows that types C has seasonal attribute, and it reaches maxmiu contribution in April. 
